...
<script type="text/javascript">
	...
	function sc_ask_confirm() {
		return '<?php _e( 'If you leave, you will lose all your conversations' , 'sc_chat' ); ?>.';
	}
	...
	<div id="Conversations">
		<div class="inner">
			...
			<div class="sc-chat-wall">
				...
				<div class="sc-chat-tab-contents">
					<div id="Console" class="active sc-chat-tab-content">&nbsp;</div>
				</div>
			</div>

    ...
    <div id="main" class="container">
        ...
        <section id="content-fullwidth" class="grid full">
            ...
            <?php if ( have_posts() ) : ?>
                ...
                <div class="portfolio-items isotope-container isotope-2-columns row">
                    <?php while ( have_posts() ) : the_post(); ?>
                        <?php $terms = get_the_terms( get_the_ID(), 'portfolio_category' ); ?>
                        <div class="portfolio-item grid one-half <?php if($terms) : foreach ($terms as $term) { echo $term->slug . ' '; } endif; ?>">

<article id="post-<?php the_ID(); ?>" <?php post_class('entry clearfix'); ?>>
	...
	<div class="entry-badge">
	    <a href="<?php the_permalink(); ?>"><i class="icon-film"></i></a>
	</div>

	<?php $video_url = get_post_meta( $post->ID, 'ft_video_url', true );
		if( $video_url ) : ?>
		<div class="entry-asset asset-video video-container">
			<?php echo wp_oembed_get( $video_url, array( 'width' => '548' ) ); ?>
	    </div>
	<?php endif; ?>

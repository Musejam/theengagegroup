...
function freshthemes_delete_resized_images( $post_id ){
	...
	$image_dir = $upload_dir . '/'. $pathinfo['dirname'] .'/';

	foreach ($sizes as $size) {
		$file = $image_dir . $size['file'];
		@unlink($file);
	}
}

add_action('delete_attachment', 'freshthemes_delete_resized_images');

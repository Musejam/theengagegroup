	...
	$shortcodes_config['video'] = array(
		...
		'options' => array(
			'url' => array(
				...
				'desc' => __('Paste the video URL here, click <a href="http://codex.wordpress.org/Embeds#Okay.2C_So_What_Sites_Can_I_Embed_From.3F" target="_blank">here</a> to see all available video hosts.', THEME_FX),
				'type' => 'text',
				'std' => ''
			)
		),
		'shortcode' => '[video url="{{url}}" /]',
		'popup_title' => __('Insert Video Shortcode', THEME_FX)
	);

 ...
 * 	----------------------------------------------------- */
	$shortcodes_config['pricing'] = array(
		...
		'child' => array(
			'options' => array(
				'featured' => array(
					'name' => __('Featured Plan',  THEME_FX),
					'desc' => __('Check to set this plan as featured', THEME_FX),
					'type' => 'checkbox',
					'std' => '0',
				),
				'title' => array(
					'name' => __('Plan Title', THEME_FX),
					'desc' => __('Enter the plan title.', THEME_FX),
					'type' => 'text',
					'std' => ''
				),
				'price' => array(
					'name' => __('Plan Price', THEME_FX),
					'desc' => __('Enter the plan price.', THEME_FX),
					'type' => 'text',
					'std' => ''
				),
				'term' => array(
					'name' => __('Plan Term', THEME_FX),
					'desc' => __('Enter the plan term. e.g : "per month", "per year" etc.', THEME_FX),
					'type' => 'text',
					'std' => ''
				),
				'button_text' => array(
					'name' => __('Plan Button Text', THEME_FX),
					'desc' => __('Enter the button text label.', THEME_FX),
					'type' => 'text',
					'std' => ''
				),
				'button_link' => array(
					'name' => __('Plan Button Link', THEME_FX),
					'desc' => __('Enter the button link destination URL.', THEME_FX),
					'type' => 'text',
					'std' => ''
				),
				'content' => array(
					'name' => __('Plan Content',  THEME_FX),
		...
		'popup_title' => __('Insert Pricing Shortcode',  THEME_FX)
	);

/* 	Page builder module config
 * 	----------------------------------------------------- */
	$freshbuilder_modules['pricing'] = array(
		'name' => __('Pricing Table', THEME_FX),
		'size' => 'one_full',
		'options' => array(
			'column' => array(
				'name' => __('Column', THEME_FX),

 ...
 * 	----------------------------------------------------- */
	$shortcodes_config['tabs'] = array(
		...
		'child' => array(
			'options' => array(
				'title' => array(
					'name' => __('Tab Title',  THEME_FX),
					'desc' => __('Enter the tab title.',  THEME_FX),
					'type' => 'text',
					'std' => ''
				),
				'icon' => array(
			...
			'clone' => __('Add More Tab',  THEME_FX )
		),
		'shortcode' => '[tabs]{{child}}[/tabs]',
		'popup_title' => __('Insert Tabs Shortcode',  THEME_FX)
	);

/* 	Page builder module config
 * 	----------------------------------------------------- */
	$freshbuilder_modules['tabs'] = array(
		'name' => __('Tabs', THEME_FX),
		'size' => 'one_half',
		'options' => array(
			'heading' => array(
				'name' => __('Heading', THEME_FX),
		...
		'child' => array(
			...
			'content' => array(
				...
				'desc' => __('Enter the tab content', THEME_FX),
				'type' => 'textarea',
				'class' => '',
				'is_content' => 1
			)
